...
function App() {
  ...
  return (
    <div>
      <BrowserRouter>
      <Routes >
          <Route path="/main" element={<BackgroundGenerica bell={bell}  componente={<Tablas/> } foot={<Footer logo={logo} style={{ display: "flex", backgroundColor: "#9FCB51", width: "100%"}} />} estilo={{backgroundColor:"#FAFDD3", marginTop: "2rem" ,   marginBottom: "5rem", marginLeft:"8rem", marginRight:"8rem", paddingTop:"2rem"}}  /> } />
