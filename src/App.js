  ...
  return (
    <div>
      ...
      <Routes >
          ...
          <Route path="/" element={  <Background componente={<Login/>} foot={<Footer logo={logo} style={{ display: "flex", backgroundColor: "#9FCB51", width: "100%", bottom: "0", position: "absolute", padding: "1rem" }}/> } estilo={{backgroundColor:"#FFEDED", marginTop: "10rem" , borderRadius: ".5rem",  }} className="container w-25"  />} />
        </Routes >
      </BrowserRouter>
